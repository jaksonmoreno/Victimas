...
Public Class clsComunitario

    Private _Id_Comunitario As Integer
    ...
    Private _NombreOrganizacion As String
    ...
    Public Property Id_Comunitario As Integer
        Get
            Return _Id_Comunitario
        End Get
        Set(ByVal value As Integer)
            _Id_Comunitario = value
        End Set
    End Property
    ...
    Public Property Tortura() As Integer
        ...
        End Set
    End Property
    Public Property Vinculacion() As Integer
        Get
            Return _Vinculacion
        End Get
        Set(ByVal value As Integer)
    ...
    Public Sub Load(pId As Integer)
        ...
        Try
            ...
            Dim ObjItems As New CmdParametro("@Id_Comunitario", pId, SqlDbType.Int, True)
            objParametros.Add(ObjItems)


            ds = clsBitacora.GetSelect("app.spViolenciaComunitarioById", objParametros, HttpContext.Current.Session, 2488, False)
            If Not ds Is Nothing Then
                If ds.Tables.Count > 0 Then
                    If ds.Tables(0).Rows.Count > 0 Then
                        Dr = ds.Tables(0).Rows(0)
                        _Id_Comunitario = Dr("Id_Comunitario")
                        ...
                        _NombreOrganizacion = Dr("NombreOrganizacion").ToString
                        ...
                        _Vinculacion = Dr("Vinculacion").ToString
            ...
            If Dr Is Nothing Then
                Throw (New Exception("Registro Comunitario no existe"))
            End If
        Catch ex As Exception
            Throw New Exception(ex.Message & " Obteniendo Registro Comunitario")
        End Try
    End Sub
    Public Function BuscarComunitarioById(ByVal Id_Comunitario As Integer) As DataTable

        Dim bResp As Boolean = False
        Dim Datos As New DataSet
        Dim objparametros As New Collection
        Dim ObjItems As New CmdParametro("@Id_Comunitario", Id_Comunitario, SqlDbType.Int, False)
        objparametros.Add(ObjItems)

        Datos = clsBitacora.GetSelect("app.spViolenciaComunitarioById", objparametros, HttpContext.Current.Session, 281, False)
...
#Region "CRUD"
    ...
    Public Function Insertar() As Integer
        ...
        coleccionParametros.Add(parametro)
        parametro = New CmdParametro("@NombreOrganizacion", NombreOrganizacion, SqlDbType.VarChar, False, 60)
        coleccionParametros.Add(parametro)
        ...
        coleccionParametros.Add(parametro)
        parametro = New CmdParametro("@Vinculacion", Vinculacion, SqlDbType.Int, False)
        coleccionParametros.Add(parametro)
        ...
        coleccionParametros.Add(parametro)
        parametro = New CmdParametro("@Aplicativo", Aplicativo, SqlDbType.VarChar, False)
        coleccionParametros.Add(parametro)
        parametro = New CmdParametro("@Escaner", Escaner, SqlDbType.Int, False)
        coleccionParametros.Add(parametro)

        Dim Id_Com As Integer = clsBitacora.Insert("dbo.spInsertViolenciaComunitario", coleccionParametros, HttpContext.Current.Session, 2005377, True)

        If Id_Com <= 0 Then
            Throw New Exception(clsBitacora.MsgError & " Insertando Violencia Comunitario")
        Else
            _Id_Comunitario = Id_Com
        End If
        Return Id_Com
    End Function
    Public Function Actualizar() As Integer
        ...
        Dim Id_Com As Integer = clsBitacora.Update("[app].[spViolenciaComunitarioUpdate]", coleccionParametros, HttpContext.Current.Session, 2490, True)
        If Id_Com <> 0 Then
            Throw New Exception(clsBitacora.MsgError & " Actualizando Comunitario")
        End If
        Return Id_Com
    End Function
#End Region
