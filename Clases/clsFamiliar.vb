...
Public Class clsFamiliar
    ...
    Private _Id_Familiar As Integer
    ...
    Public Property Id_Familiar As Integer
        Get
            Return _Id_Familiar
        End Get
    ...
    Public Sub Load(pId As Integer)
        ...
        Try
            ...
            Dim ObjItems As New CmdParametro("@Id_Familiar", pId, SqlDbType.Int, True)
            objParametros.Add(ObjItems)


            ds = clsBitacora.GetSelect("app.spViolenciaFamiliarById", objParametros, HttpContext.Current.Session, 2488, False)
            If Not ds Is Nothing Then
                If ds.Tables.Count > 0 Then
                    If ds.Tables(0).Rows.Count > 0 Then
                        Dr = ds.Tables(0).Rows(0)
                        _Id_Familiar = Dr("Id_Familiar")
            ...
            If Dr Is Nothing Then
                Throw (New Exception("Registro Familiar no existe"))
            End If
        Catch ex As Exception
            Throw New Exception(ex.Message & " Obteniendo Registro Familiar")
        End Try
    End Sub
    Public Function BuscarFamiliarById(ByVal Id_Familiar As Integer) As DataTable

        Dim bResp As Boolean = False
        Dim Datos As New DataSet
        Dim objparametros As New Collection
        Dim ObjItems As New CmdParametro("@Id_Familiar", Id_Familiar, SqlDbType.Int, False)
        objparametros.Add(ObjItems)

        Datos = clsBitacora.GetSelect("app.spViolenciaFamiliarById", objparametros, HttpContext.Current.Session, 281, False)
...
#Region "CRUD"
    ...
    Public Function Insertar() As Integer
        ...
        coleccionParametros.Add(parametro)
        parametro = New CmdParametro("@Familia", Familia, SqlDbType.VarChar, False, 60)
        coleccionParametros.Add(parametro)
        ...
        coleccionParametros.Add(parametro)
        parametro = New CmdParametro("@Edad", Edad, SqlDbType.Int, False)
        coleccionParametros.Add(parametro)
        ...
        Dim Id_Fam As Integer = clsBitacora.Insert("dbo.spInsertViolenciaFamiliar", coleccionParametros, HttpContext.Current.Session, 2005377, True)

        If Id_Fam <= 0 Then
            Throw New Exception(clsBitacora.MsgError & " Insertando Violencia Familiar")
        Else
            _Id_Familiar = Id_Fam
        End If
        Return Id_Fam
    ...
    Public Function Actualizar() As Integer
        ...
        Dim Id_Fam As Integer = clsBitacora.Update("[app].[spViolenciaFamiliarUpdate]", coleccionParametros, HttpContext.Current.Session, 2490, True)
        If Id_Fam <> 0 Then
            Throw New Exception(clsBitacora.MsgError & " Actualizando Familiar")
        End If
        Return Id_Fam
    End Function
#End Region
