<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAdminFamiliar.aspx.vb" Inherits="Victimas_frmAdminFamiliar" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
            ...
            function ShowForm(Id_Familiar, rowIndex) {
                var grid = window["<%= rgFamiliar.ClientID%>"];
                var ventana1 = window.radopen("frmFamiliar.aspx?opcion=view&Id_Familiar=" + Id_Familiar + "&n=" + (Math.random()), "UserListDialog");
            ventana1.Restore();
            ventana1.maximize();
            return false;
        }

        function ShowEditForm(Id_Familiar, rowIndex) {
            var grid = window["<%= rgFamiliar.ClientID%>"];
            var ventana4 = window.radopen("frmFamiliar.aspx?opcion=edit&Id_Familiar=" + Id_Familiar + "&n=" + (Math.random()), "UserListDialog");
            ventana4.Restore();
            ventana4.maximize();
            return false;
        }
        ...
        function ShowInsertForm() {
            var ventana5 = window.radopen("frmFamiliar.aspx?opcion=new" + "&n=" + (Math.random()), "UserListDialog");
            ventana5.Restore();
            ventana5.maximize();
            return false;
        }
        ...
        function refreshGrid(arg) {
            if (!arg) {
                var masterTable = $find("<%= rgFamiliar.ClientID%>").get_masterTableView();
                masterTable.rebind();
            }
            else {
                var masterTable = $find("<%= rgFamiliar.ClientID%>").get_masterTableView();
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <telerik:RadGrid ID="rgFamiliar" runat="server" AutoGenerateColumns="False" EnableAJAX="True"
                ...
                <MasterTableView AllowFilteringByColumn="True" CommandItemDisplay="Top" DataKeyNames="Id_Familiar, Id_Familiar" NoMasterRecordsText="No hay eventos para mostrar.">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Id_Familiar" HeaderText="Ficha" UniqueName="Id_Familiar"
                        ...
                        <telerik:GridTemplateColumn UniqueName="ver" AllowFiltering="False">
                            <ItemTemplate>
                                <asp:Image ID="VerFamiliar" runat="server" ImageUrl="~/Imagenes/ver.gif" />
                            </ItemTemplate>
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Center" Wrap="True" />
                        </telerik:GridTemplateColumn>
                    ...
                    <CommandItemSettings AddNewRecordText="Agregar Violencia Modalidad Familiar" RefreshText="Actualizar" />
                    <CommandItemTemplate>
