<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAdminIndividualGrupal.aspx.vb" Inherits="Victimas_frmAdminIndividualGrupal" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ShowForm(Id_IndividualGrupal, rowIndex) {
            var grid = window["<%= rgIndividualGrupal.ClientID%>"];
            var ventana1 = window.radopen("frmIndividualGrupal.aspx?opcion=view&Id_IndividualGrupal=" + Id_IndividualGrupal + "&n=" + (Math.random()), "UserListDialog");
            ventana1.Restore();
            ventana1.maximize();
            return false;
        }

        function ShowEditForm(Id_IndividualGrupal, rowIndex) {
            var grid = window["<%= rgIndividualGrupal.ClientID%>"];
            var ventana4 = window.radopen("frmIndividualGrupal.aspx?opcion=edit&Id_IndividualGrupal=" + Id_IndividualGrupal + "&n=" + (Math.random()), "UserListDialog");
            ventana4.Restore();
            ventana4.maximize();
            return false;
        }
        ...
        function ShowInsertForm() {
            var ventana5 = window.radopen("frmIndividualGrupal.aspx?opcion=new" + "&n=" + (Math.random()), "UserListDialog");
            ventana5.Restore();
            ventana5.maximize();
            return false;
        }
        ...
        function refreshGrid(arg) {
            if (!arg) {
                var masterTable = $find("<%= rgIndividualGrupal.ClientID%>").get_masterTableView();
                masterTable.rebind();
            }
            else {
                var masterTable = $find("<%= rgIndividualGrupal.ClientID%>").get_masterTableView();
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <telerik:RadGrid ID="rgIndividualGrupal" runat="server" AutoGenerateColumns="False" EnableAJAX="True"
                ...
                <MasterTableView AllowFilteringByColumn="True" CommandItemDisplay="Top" DataKeyNames="Id_IndividualGrupal, Id_IndividualGrupal" NoMasterRecordsText="No hay eventos para mostrar.">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Id_IndividualGrupal" HeaderText="Ficha" UniqueName="Id_IndividualGrupal"
                        ...
                        <telerik:GridTemplateColumn UniqueName="ver" AllowFiltering="False">
                            <ItemTemplate>
                                <asp:Image ID="VerIndividualGrupal" runat="server" ImageUrl="~/Imagenes/ver.gif" />
                            </ItemTemplate>
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Center" Wrap="True" />
                        </telerik:GridTemplateColumn>
                    ...
                    <CommandItemSettings AddNewRecordText="Agregar Violencia Modalidad Individual Grupal" RefreshText="Actualizar" />
                    <CommandItemTemplate>
