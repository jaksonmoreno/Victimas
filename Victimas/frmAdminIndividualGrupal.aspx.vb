...
Imports System.Data
Partial Class Victimas_frmAdminIndividualGrupal
    ...
    Private oIndiGrupal As New clsIndividualGrupal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            If clsSeguridad.ValidarPermisos(Session, "IndividualGrupal") = False Then
                Response.Redirect("../Administrador/Seguridad/Paginasinprivilegios.htm", True)
            End If

            clsSeguridad.FiltrarGrilla(Session, "IndividualGrupal", rgIndividualGrupal)
            Dim Datos As New DataSet
            Dim objparametros As New Collection
            Dim ObjItems As New CmdParametro("@NombreFormulario", "IndividualGrupal", SqlDbType.Char, False, 100)
    ...
    Public ReadOnly Property ObtenerDatos() As DataSet
        ...
        Get
            ...
            Try
                ...
                objparametros.Add(prmt)
                Datos = clsBitacora.GetSelect("app.SpGetIndividualGrupal", objparametros, Session, 126, False)   '<JPaez 09-12-2010>
    ...
    ''' <param name="e"></param>
    ''' <remarks>
    ''' Elimina un registro de la tabla tblIndividualGrupal al eliminarlo de la grilla.
    ''' </remarks>
    Protected Sub RadGrid1_DeleteCommand(ByVal source As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs) Handles rgIndividualGrupal.DeleteCommand
        Dim editedItem As GridEditableItem = CType(e.Item, GridEditableItem)

        Dim Indice As String = e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("Id_IndividualGrupal")
        Dim Objparametros As New Collection
        Dim ObjItems As New CmdParametro("@Id_IndividualGrupal", Indice, SqlDbType.Int, True)
        Objparametros.Add(ObjItems)
        Dim update As String = clsBitacora.Update("spDeletetblViolenciaIndividualGrupal", Objparametros, Session, 280, True)
        If update <> "0" Then
            rgIndividualGrupal.Controls.Add(New LiteralControl("Hubo un Error en el Servidor de BD Id Error: " & update))
        End If
    End Sub
    ''' <summary>
    ...
    ''' </remarks>
    Protected Sub rgIndividualGrupal_ItemCreated(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles rgIndividualGrupal.ItemCreated
        ...
        If TypeOf e.Item Is GridDataItem Then
            ...
            AbrirArchivo.Attributes("onClick") = String.Format("return ShowEditForm('{0}','{1}');", e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("Id_IndividualGrupal"), e.Item.ItemIndex)
            AbrirArchivo.Style.Add("cursor", "hand")
            AbrirArchivo.ToolTip = "Haga click aqui para editar violencia individual grupal"


            Dim AbrirArchivoVer As Image = e.Item.FindControl("VerIndividualGrupal")
            AbrirArchivoVer.Attributes("onClick") = String.Format("return ShowForm('{0}','{1}');", e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("Id_IndividualGrupal"), e.Item.ItemIndex)
            AbrirArchivoVer.Style.Add("cursor", "hand")
            AbrirArchivoVer.ToolTip = "Haga click aqui para ver violencia individual grupal"
        ...
        Try
            ...
            If TypeOf sourceControl Is RadGrid Then
                Select Case eventArgument
                    Case "Rebind"
                        rgIndividualGrupal.MasterTableView.SortExpressions.Clear()
                        rgIndividualGrupal.MasterTableView.GroupByExpressions.Clear()
                        rgIndividualGrupal.Rebind()
                    Case "RebindAndNavigate"
                        rgIndividualGrupal.MasterTableView.SortExpressions.Clear()
                        rgIndividualGrupal.MasterTableView.GroupByExpressions.Clear()
                        rgIndividualGrupal.MasterTableView.CurrentPageIndex = rgIndividualGrupal.MasterTableView.PageCount - 1
                        rgIndividualGrupal.Rebind()
                End Select
            End If
        Catch ex As Exception
    ...
    ''' </remarks>
    Protected Sub rgIndividualGrupal_NeedDataSource(ByVal source As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles rgIndividualGrupal.NeedDataSource

        'Me.RadGrid1.DataSource = ObtenerDatos(0, "", "", "").Tables("Datos")
        Me.rgIndividualGrupal.DataSource = ObtenerDatos().Tables("Datos")
    ...
    Private Sub FilterEspanish()
        Dim Menu As GridFilterMenu = Me.rgIndividualGrupal.FilterMenu
    ...
    Protected Sub btnFiltrar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFiltrar.Click
        ...
        Me.rgIndividualGrupal.DataSource = ObtenerDatos
        Me.rgIndividualGrupal.DataBind()

    End Sub
    Protected Sub btnNoFiltrar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNoFiltrar.Click

        For Each column As GridColumn In rgIndividualGrupal.MasterTableView.Columns
            column.CurrentFilterFunction = GridKnownFunction.NoFilter
            column.CurrentFilterValue = String.Empty
        Next

        rgIndividualGrupal.MasterTableView.FilterExpression = String.Empty
        rgIndividualGrupal.MasterTableView.Rebind()
