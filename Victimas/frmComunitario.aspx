<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmComunitario.aspx.vb" Inherits="Victimas_frmComunitario" %>
...
<head id="Head1" runat="server">
    <title>Modalidad Comunitario</title>
    ...
    <script src="Scripts/Comunitario.js" type="text/javascript"></script>
</head>
<body>
        ...
        <div class="container">
            <center>
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <br />
                        <h4>Reporte de información de personas víctimas del conflicto armado con procesos de atención psicosocial en la modalidad comunitaria.</h4>
                    </div>
                    <br />
                    <div class="col-sm-2">
            ...
            <div style="border-top-style: solid; border-right-style: solid; border-left-style: solid; border-bottom-style: solid; border-top-width: 1px; border-right-width: 1px; border-left-width: 1px; border-bottom-width: 1px; border-top-color: #99CCFF; border-right-color: #99CCFF; border-left-color: #99CCFF; border-bottom-color: #99CCFF">
                <table class="table">
                    <tr>
                        <td class="info">
                            <center><b>Atención Psicosocial Modalidad Comunitaria.</b></center>
                        </td>
                    </tr>
                </table>
                <table class="table">
                ...
                <div class="row">
                    <div class="col-sm-2">Nombre Organización:</div>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="txtNombreOrganizacion" maxlength="50" style="text-transform: uppercase;" value="" onkeyup="javascript:this.value=this.value.toUpperCase();" runat="server" tabindex="1" />
                    </div>
                ...
                <div class="row">
                    ...
                    <br />
                    <div class="col-sm-2">Nivel de Atención:</div>
                    <div class="col-sm-3">
                        <select class="form-control" id="cboNivel" runat="server" name="cboNivel" tabindex="33">
                            <option value="-1">Seleccione...</option>
                            <option value="1">Atención en Situaciones Emergentes</option>
                            <option value="2">Fortalecimiento Colectivo</option>
                            <option value="3">Reconstrucción de las Memorias</option>
                            <option value="4">Reconocimiento Social</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <asp:DropDownList runat="server" ID="cboOrientacionTemat" CssClass="form-control" DataValueField="Id_Orientacion" DataTextField="NombreOrientacion" TabIndex="34"></asp:DropDownList>
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                    <br />
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker2' runat="server">
                                    <input type='text' class="form-control" id="dtpAcercamiento" runat="server" tabindex="35" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker3' runat="server">
                                <input type='text' class="form-control" id="dtpSeguimiento2" runat="server" tabindex="36" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker4' runat="server">
                                    <input type='text' class="form-control" id="dtpSeguimiento3" runat="server" tabindex="37" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker5' runat="server">
                                <input type='text' class="form-control" id="dtpSeguimiento4" runat="server" tabindex="38" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker6' runat="server">
                                    <input type='text' class="form-control" id="dtpSeguimiento5" runat="server" tabindex="39" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker7' runat="server">
                                <input type='text' class="form-control" id="dtpSeguimiento6" runat="server" tabindex="40" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker8' runat="server">
                                    <input type='text' class="form-control" id="dtpSeguimiento7" runat="server" tabindex="41" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker9' runat="server">
                                <input type='text' class="form-control" id="dtpSeguimiento8" runat="server" tabindex="42" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker10' runat="server">
                                    <input type='text' class="form-control" id="dtpCierre" runat="server" tabindex="43" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                    ...
                    <table class="table">
                        <tr>
                            <td class="info">
                                <center><b>Seguimientos Salud Física</b></center>
                            </td>
                        </tr>
                    </table>
                    <div class="col-sm-2">SF_Seguimiento 1:</div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker11' runat="server">
                                <input type='text' class="form-control" id="dtpSF_Seguimiento1" runat="server" tabindex="44" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">SF_Seguimiento 2:</div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker12' runat="server">
                                    <input type='text' class="form-control" id="dtpSF_Seguimiento2" runat="server" tabindex="45" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                    ...
                    <br />
                    <div class="col-sm-2">SF_Seguimiento 3:</div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker13' runat="server">
                                <input type='text' class="form-control" id="dtpSF_Seguimiento3" runat="server" tabindex="46" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">SF_Seguimiento 4:</div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker14' runat="server">
                                    <input type='text' class="form-control" id="dtpSF_Seguimiento4" runat="server" tabindex="47" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                    ...
                    <br />
                    <div class="col-sm-2">SF_Seguimiento 5:</div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker15' runat="server">
                                <input type='text' class="form-control" id="dtpSF_Seguimiento5" runat="server" tabindex="48" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">Gestión 1:</div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker16' runat="server">
                                    <input type='text' class="form-control" id="dtpGestion1" runat="server" tabindex="49" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                    ...
                    <br />
                    <div class="col-sm-2">Gestión 2:</div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker17' runat="server">
                                <input type='text' class="form-control" id="dtpGestion2" runat="server" tabindex="50" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">Gestión 3:</div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker18' runat="server">
                                    <input type='text' class="form-control" id="dtpGestion3" runat="server" tabindex="51" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                    ...
                    <br />
                    <div class="col-sm-2">Gestión 4:</div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker19' runat="server">
                                <input type='text' class="form-control" id="dtpGestion4" runat="server" tabindex="52" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">Gestión 5:</div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker20' runat="server">
                                    <input type='text' class="form-control" id="dtpGestion5" runat="server" tabindex="53" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                    ...
                    <br />
                    <div class="col-sm-2">Gestión 6:</div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker21' runat="server">
                                <input type='text' class="form-control" id="dtpGestion6" runat="server" tabindex="54" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">Gestión 7:</div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker22' runat="server">
                                    <input type='text' class="form-control" id="dtpGestion7" runat="server" tabindex="55" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                    ...
                    <br />
                    <div class="col-sm-2">Gestión 8:</div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker23' runat="server">
                                <input type='text' class="form-control" id="dtpGestion8" runat="server" tabindex="56" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">Gestión 9:</div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker24' runat="server">
                                    <input type='text' class="form-control" id="dtpGestion9" runat="server" tabindex="57" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                    ...
                    <br />
                    <div class="col-sm-2">Gestión 10:</div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker25' runat="server">
                                <input type='text' class="form-control" id="dtpGestion10" runat="server" tabindex="58" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                    ...
                    <table class="table">
                        <tr>
                            <td class="info">
                                <center><b>Derivaciones</b></center>
                            </td>
                        </tr>
                    </table>
                    <div class="col-sm-2">Derivación 1:</div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker26' runat="server">
                                <input type='text' class="form-control" id="dtpDerivacion1" runat="server" tabindex="59" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">Derivación 2:</div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker27' runat="server">
                                    <input type='text' class="form-control" id="dtpDerivacion2" runat="server" tabindex="60" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                    ...
                    <br />
                    <div class="col-sm-2">Derivación 3:</div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker28' runat="server">
                                <input type='text' class="form-control" id="dtpDerivacion3" runat="server" tabindex="61" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">Derivación 4:</div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker29' runat="server">
                                    <input type='text' class="form-control" id="dtpDerivacion4" runat="server" tabindex="62" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">Nivel de Efectividad:</div>
                        <div class="col-sm-3">
                            <select class="form-control" id="cboNivEfec" runat="server" name="cboNivEfec" tabindex="63">
                                <option value="-1">Seleccione...</option>
                                <option value="1">Sí</option>
                                <option value="2">No</option>
                            </select>
                        </div>
                        <div class="col-sm-2">Motivo de Cierre:</div>
                        <div class="col-sm-3">
                            <select class="form-control" id="cboMotivoCier" runat="server" name="cboMotivoCier" tabindex="64">
                                <option value="-1">Seleccione...</option>
                                <option value="1">Cumplimiento de Objetivos</option>
                                <option value="2">No Disponibilidad de Tiempo</option>
                                <option value="3">Traslado de Lugar de Residencia</option>
                                <option value="4">Perdida de Contacto</option>
                                <option value="5">Situación de Seguridad</option>
                                <option value="6">No Interes</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <select class="form-control" id="cboAseguramiento" runat="server" name="cboAseguramiento" tabindex="65">
                                <option value="-1">Seleccione...</option>
                        ...
                        <div class="col-sm-3">
                            <asp:DropDownList runat="server" ID="cboEAPB" CssClass="form-control" DataValueField="Id_Aseguradora" DataTextField="NombreAseguradora" TabIndex="66"></asp:DropDownList>
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                    <br />
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <asp:DropDownList runat="server" ID="cboProyectoViv" CssClass="form-control" DataValueField="Id_PuntoViv" DataTextField="NombrePuntoViv" TabIndex="67"></asp:DropDownList>
                        </div>
                        <div class="col-sm-2">Remitido Por</div>
                        <div class="col-sm-3">
                            <asp:DropDownList runat="server" ID="cboRemitidoP" CssClass="form-control" DataValueField="Id_Remitido" DataTextField="NombrePuntoViv" TabIndex="68"></asp:DropDownList>
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                    <br />
                    <div class="row">
                        <div class="col-sm-2">Calificación:</div>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="txtCalificacion" maxlength="2" runat="server" onkeypress='return event.charCode >= 48 && event.charCode <= 57' tabindex="69" />
                        </div>
                        <div class="col-sm-2">IRH:</div>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="txtIRH" maxlength="2" runat="server" onkeypress='return event.charCode >= 48 && event.charCode <= 57' tabindex="70" />
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                    <br />
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" id="txtObservaciones" maxlength="300" rows="4" style="text-transform: uppercase;" value="" onkeyup="javascript:this.value=this.value.toUpperCase();" runat="server" tabindex="71"></textarea>
                            <div class="col-sm-2"></div>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        <div class="col-sm-2">Aplicativo MSPS:</div>
                        <div class="col-sm-3">
                            <select class="form-control" id="cboAplicativo" runat="server" name="cboAplicativo" tabindex="72">
                                <option value="-1">Seleccione...</option>
                                <option value="1">Si</option>
                                <option value="2">No</option>
                            </select>
                        ...
                        <div class="row">
                            <div class="col-sm-2">Escaner:</div>
                            <div class="col-sm-3">
                                <select class="form-control" id="cboEscaner" runat="server" name="cboEscaner" tabindex="73">
                                    <option value="-1">Seleccione...</option>
                                    <option value="1">Si</option>
                                    <option value="2">No</option>
                                </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-primary" runat="server" id="btnInsertar" tabindex="74">
                        ...
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-primary" runat="server" id="btnCancelar" onserverclick="btnCancelar_ServerClick" tabindex="75">
