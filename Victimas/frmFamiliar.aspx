<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmFamiliar.aspx.vb" Inherits="Victimas_frmFamiliar" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Modalidad Familiar</title>
    ...
    <script src="Scripts/Familiar.js" type="text/javascript"></script>
</head>
<body>
        ...
        <div class="container">
            <center>
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <br />
                        <h4>Reporte de información de personas víctimas del conflicto armado con procesos de atención psicosocial en la modalidad familiar.</h4>
                    </div>
                    <br />
                    <div class="col-sm-2">
            ...
            <div style="border-top-style: solid; border-right-style: solid; border-left-style: solid; border-bottom-style: solid; border-top-width: 1px; border-right-width: 1px; border-left-width: 1px; border-bottom-width: 1px; border-top-color: #99CCFF; border-right-color: #99CCFF; border-left-color: #99CCFF; border-bottom-color: #99CCFF">
                <table class="table">
                    <tr>
                        <td class="info">
                            <center><b>Atención Psicosocial Modalidad Familiar</b></center>
                        </td>
                    </tr>
                </table>
                <table class="table">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="txtFamilia" maxlength="50" style="text-transform: uppercase;" value="" onkeyup="javascript:this.value=this.value.toUpperCase();" runat="server" tabindex="1" />
                    </div>
                    <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="txtEdad" maxlength="50" onkeypress="return SoloNumerosNum()" runat="server" tabindex="12" />
                    </div>
                    <div class="col-sm-2"></div>
                </div>
                <br />
                ...
                <div class="col-sm-3">
                    <select class="form-control" id="cboNivel" runat="server" name="cboNivel" tabindex="33">
                        <option value="-1">Seleccione...</option>
                        <option value="1">Atención en Consejería y Apoyo</option>
                        <option value="2">Atención Terapéutica</option>
                    </select>
                </div>
                <div class="row">
