...
Partial Class Victimas_frmFamiliar
    Inherits System.Web.UI.Page

    Private oFamiliar As New clsFamiliar
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        Select Case mode
            Case "new"
                Me.Title = "Crear Nuevo Registro Familiar"
            Case "edit"
                Me.Title = "Editar Familiar"
                Dim oFamiliar As New clsFamiliar()
                oFamiliar.Load(Request.QueryString("Id_Familiar"))

                Me.cboPuntoAten.SelectedValue = oFamiliar.PuntoAtencion
                Me.dtpFechaApert.Value = oFamiliar.FechaApert
                Me.cboTipoDoc.Value = oFamiliar.TipoDoc
                Me.txtNumDoc.Value = oFamiliar.NumDoc
                Me.txtPrimerNombre.Value = oFamiliar.PrimerNombre
                Me.txtSegundoNombre.Value = oFamiliar.SegundoNombre
                Me.txtPrimerApellido.Value = oFamiliar.PrimerApellido
                Me.txtSegundoApellido.Value = oFamiliar.SegundoApellido
                Me.txtFamilia.Value = oFamiliar.Familia
                Me.txtTelefono.Value = oFamiliar.Telefono
                Me.cboGenero.Value = oFamiliar.Genero
                Me.txtEdad.Value = oFamiliar.Edad
                Me.cboPertEtnica.Value = oFamiliar.PertEtnica
                Me.cboSituaCon.Value = oFamiliar.SituaCon
                Me.chkAreaRural.Checked = oFamiliar.AreaRural
                Me.txtDireccionPCO.Text = oFamiliar.DireccionPCO
                Me.rcbLocalidadPCO.SelectedValue = oFamiliar.LocalidadPCO
                Me.rcbBarrio.SelectedValue = oFamiliar.Barrio
                CargarBarriosLocalidad(oFamiliar.LocalidadPCO)
                Me.rcbNombreUpz.SelectedValue = oFamiliar.NombreUpz
                BindUpz()
                Me.cboTerrorista.Value = oFamiliar.Terrorista
                Me.cboAmenaza.Value = oFamiliar.Amenaza
                Me.cboDelitos.Value = oFamiliar.Delitos
                Me.cboDesaparicion.Value = oFamiliar.Desaparicion
                Me.cboDesplazamiento.Value = oFamiliar.Desplazamiento
                Me.cboHomicidio.Value = oFamiliar.Homicidio
                Me.cboMasacre.Value = oFamiliar.Masacre
                Me.cboMinas.Value = oFamiliar.Minas
                Me.cboSecuestro.Value = oFamiliar.Secuestro
                Me.cboTortura.Value = oFamiliar.Tortura
                Me.cboVinculacion.Value = oFamiliar.Vinculacion
                Me.cboAbandono.Value = oFamiliar.Abandono
                Me.txtProfesional.Value = oFamiliar.Profesional
                Me.cboNivel.Value = oFamiliar.Nivel
                Me.cboOrientacionTemat.SelectedValue = oFamiliar.OrientacionTemat
                Dim EditAcercamiento = oFamiliar.Acercamiento
                If EditAcercamiento = "01/01/1900" Then
                    Me.dtpAcercamiento.Value = ""
                Else
                    Me.dtpAcercamiento.Value = EditAcercamiento
                End If
                Dim EditSeguimiento2 = oFamiliar.Seguimiento2
                If EditSeguimiento2 = "01/01/1900" Then
                    Me.dtpSeguimiento2.Value = ""
                Else
                    Me.dtpSeguimiento2.Value = EditSeguimiento2
                End If
                Dim EditSeguimiento3 = oFamiliar.Seguimiento3
                If EditSeguimiento3 = "01/01/1900" Then
                    Me.dtpSeguimiento3.Value = ""
                Else
                    Me.dtpSeguimiento3.Value = EditSeguimiento3
                End If
                Dim EditSeguimiento4 = oFamiliar.Seguimiento4
                If EditSeguimiento4 = "01/01/1900" Then
                    Me.dtpSeguimiento4.Value = ""
                Else
                    Me.dtpSeguimiento4.Value = EditSeguimiento4
                End If
                Dim EditSeguimiento5 = oFamiliar.Seguimiento5
                If EditSeguimiento5 = "01/01/1900" Then
                    Me.dtpSeguimiento5.Value = ""
                Else
                    Me.dtpSeguimiento5.Value = EditSeguimiento5
                End If
                Dim EditSeguimiento6 = oFamiliar.Seguimiento6
                ...
                Dim EditSF_Seguimiento2 = oFamiliar.SF_Seguimiento2
                ...
                Dim EditSF_Seguimiento3 = oFamiliar.SF_Seguimiento3
                ...
                Dim EditSF_Seguimiento4 = oFamiliar.SF_Seguimiento4
    ...
    Private Function ProcesarNuevo() As Boolean
        ...
        End With
        Try
            Dim sFami As Integer = oFamiliar.Insertar()
            If sFami <= 0 Then
                sFam = False
    ...
    Private Function Procesareditar() As Boolean
        ...
        oFamiliar.Load(Request.QueryString("Id_Familiar"))
        With oFamiliar
            .Id_Familiar = Request.QueryString("Id_Familiar")
            If cboPuntoAten.SelectedValue <> "Seleccione..." Then
                .PuntoAtencion = cboPuntoAten.SelectedValue
            End If
            .FechaApert = Me.dtpFechaApert.Value
        ...
        End With
        Try
            Dim sFami As Integer = oFamiliar.Actualizar
            If sFami <> 0 Then
                Me.RadAjaxManager1.Alert("Error: ")
                sFam = False
            Else
    ...
    '''' <autor> En Violencias Familiar usado por Jakson Moreno R 18 -05 -2021</autor>
    ...
    Private Function CargarDatos() As DataRow
        ...
        Dim Id_Familiar As Integer = Request.QueryString("Id_Familiar")
        Dim dr As Data.DataRow = Nothing
        Dim ds As New DataSet
        Dim coleccionParametros As New Collection
        Dim parametro As New CmdParametro("@Id_Familiar", Id_Familiar, SqlDbType.Int, True)
        coleccionParametros.Add(parametro)
        ds = clsBitacora.GetSelect("spViolenciaFamiliarById", coleccionParametros, Session, 35, False)
    ...
    Private Sub CargarOrientacionTem(Optional ByVal Id_Orientacion As Integer = 0)
        ...
        Dim dt As DataTable = clsBitacora.GetSelect("app.spgetOrientacionTemFam", coleccionParametros, Session, 422, False).Tables(0)
